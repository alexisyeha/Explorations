...
A portrait iPhone prototype of a suspended kinetic mobile. Six geometric weights can be caught, dragged, and released independently. Their movement transfers into the two connected rods, while each shape plays its own locally synthesized chime.
